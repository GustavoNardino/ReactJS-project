  ...
  return (
    <div className='contentPanel'>
      ...
      <div className='infoBoard'>
        ...
        <Input fieldName='Telefone (só os números)' maxLength={11} content={props.costumerData.phone} name='phone'  costumerData={props.costumerData}  costumerEvent={handleFields} />
        ...
        <Input fieldName='CPF (só os números)' maxLength={11} content={props.costumerData.cpf} name='cpf' costumerData={props.costumerData}  costumerEvent={handleFields} />    
        <h3>Endereço</h3>
        <Input fieldName='CEP (só os números)' disabled={true} content={props.costumerData.cep} name='cep'  costumerData={props.costumerData}  costumerEvent={handleFields} />
      ...
      <div className='infoBoard'>
        ...
        <Input fieldName='Número do cartão (só os números)' maxLength={16} content={props.costumerData.cardNumber} name='cardNumber' costumerData={props.costumerData} costumerEvent={handleFields} />
        <Input fieldName='Validade (só os números)' maxLength={4} content={props.costumerData.validity} name='validity' costumerData={props.costumerData} costumerEvent={handleFields} />
        ...
        <Input fieldName='CPF do portador (só os números)' maxLength={11} content={props.costumerData.cardCpf} name='cardCpf' costumerData={props.costumerData} costumerEvent={handleFields} />
